...
class FactoryTaskPegHoleInsertion(FactoryEnvInsertion, FactoryABCTask):
    ...
    def _acquire_task_tensors(self):
            ...
            # self.hole_top_pos[:,2]+=self.round_hole_heights[0] #3  round
    ...
    def _refresh_task_tensors(self):
        ...
        for idx, keypoint_offset in enumerate(self.keypoint_offsets):
            ...
            self.hole_top_pos[:,2]+=self.round_hole_heights[0] #3  rou
    ...
    def _update_rew_buf(self):
        ...
        #第二种方法  rew=distence(peg,grasper)+distence(peg,hole)  
