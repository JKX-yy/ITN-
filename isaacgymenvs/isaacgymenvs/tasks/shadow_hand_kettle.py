...
class ShadowHandKettle(VecTask):
    ...
    def compute_full_state(self, asymm_obs=False):
        ...
        398 - 404	kettle pose  7
        405 - 407	kettle linear velocity 3
        408 - 410	kettle angle velocity  3
        411 - 417	goal pose   7
        418 - 421	goal rot - object rot   四元数 4维
        422 - 424	kettle handle position  3维
        425 - 427	bucket position         3维
        """
